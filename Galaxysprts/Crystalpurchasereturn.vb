...
Public Class Crystalpurchasereturn
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Crystalpurchasereturn.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalpurchasereturn
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crystalpurchasereturn = New Crystalpurchasereturn
        rpt.Site = Me.Site
        Return rpt
    End Function
