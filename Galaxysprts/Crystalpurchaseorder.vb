...
Public Class Crystalpurchaseorder
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Crystalpurchaseorder.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalpurchaseorder
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crystalpurchaseorder = New Crystalpurchaseorder
        rpt.Site = Me.Site
        Return rpt
    End Function
